...
| `br0` | Software bridge joining `eth0` and `eth2` | UP only when both `eth0` and `eth2` are UP and configured. |
...
All responses are rendered in Discord. Apply these rules to every message.
