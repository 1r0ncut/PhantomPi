...
def register(app):
    ...
    def status():
        ...
        services = ["wg-keepalive.timer", "hidden-hotspot.service", "ntpsec-watchdog.timer", "bridge-sync.timer", "packet-sniffer.service", "power-monitor.timer", "cred-analyzer.timer"]
        status_lines = []
        for s in services:
